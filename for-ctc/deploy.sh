...
if [ ! -d "/data" ]; then
    echo "data folder not existed! Creating..."
    mkdir /data
    echo "done!"
else
...
if [ ! -d "/debug" ]; then
    echo "debug folder not existed! Creating..."
    mkdir /debug
    echo "done!"
else
    echo "debug folder existed!"
fi

if [ ! -d "./postgres/data/base" ]; then
    echo "base folder not existed! Creating..."
    mkdir -p ./postgres/data/base
    echo "done!"
else
    echo "base folder existed!"
fi

if [ ! -d "./postgres/data/global" ]; then
    echo "global folder not existed! Creating..."
    mkdir -p ./postgres/data/global
    echo "done!"
else
    echo "global folder existed!"
fi

if [ ! -d "./postgres/data/pg_commit_ts" ]; then
...
if [ ! -d "./postgres/data/pg_dynshmem" ]; then
...
if [ ! -d "./postgres/data/pg_logical" ]; then
...
if [ ! -d "./postgres/data/pg_logical/mappings" ]; then
...
if [ ! -d "./postgres/data/pg_logical/snapshots" ]; then
...
if [ ! -d "./postgres/data/pg_multixact" ]; then
...
if [ ! -d "./postgres/data/pg_notify" ]; then
...
if [ ! -d "./postgres/data/pg_replslot" ]; then
...
if [ ! -d "./postgres/data/pg_serial" ]; then
...
if [ ! -d "./postgres/data/pg_snapshots" ]; then
...
if [ ! -d "./postgres/data/pg_stat" ]; then
...
if [ ! -d "./postgres/data/pg_stat_tmp" ]; then
...
if [ ! -d "./postgres/data/pg_subtrans" ]; then
...
if [ ! -d "./postgres/data/pg_tblspc" ]; then
...
if [ ! -d "./postgres/data/pg_twophase" ]; then
...
if [ ! -d "./postgres/data/pg_wal" ]; then
...
if [ ! -d "./postgres/data/pg_wal/archive_status" ]; then
...
if [ ! -d "./postgres/data/pg_xact" ]; then
